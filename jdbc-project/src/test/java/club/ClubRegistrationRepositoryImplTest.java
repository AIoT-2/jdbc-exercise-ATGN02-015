...
import com.nhnacademy.jdbc.club.repository.impl.ClubRegistrationRepositoryImpl;
import com.nhnacademy.jdbc.club.repository.impl.ClubRepositoryImpl;
import com.nhnacademy.jdbc.student.domain.Student;
import com.nhnacademy.jdbc.student.repository.StudentRepository2;
import com.nhnacademy.jdbc.student.repository.impl.StudentRepositoryImpl;
import com.nhnacademy.jdbc.util.DbUtils2;
...
class ClubRegistrationRepositoryImplTest {
    ...
    static StudentRepository2 studentRepository = new StudentRepositoryImpl();
    static ClubRegistrationRepository clubRegistrationRepository = new ClubRegistrationRepositoryImpl();

    @BeforeAll
    static void setUp() throws SQLException {

        connection = DbUtils2.getDataSource().getConnection();
