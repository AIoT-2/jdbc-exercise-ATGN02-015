...
//        String sql = "select c.id as student_id, c.name as student_name, a.club_id, a.club_name from jdbc_club a inner join jdbc_club_registrations b on a.club_id = b.club_id inner join jdbc_student c on b.student_id = c.student_id where c.student_id=?";
...
//        }
    ...
    public List<ClubStudent> findClubStudents(Connection connection) {
        //todo#21 - join
//        String sql = "select c.id as student_id, c.name as student_name, a.club_id, a.club_name from jdbc_club a inner join jdbc_club_registrations b on a.club_id = b.club_id inner join jdbc_student on b.student_id = c.id";
